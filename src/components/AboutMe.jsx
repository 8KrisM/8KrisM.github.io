  ...
  return (
    <div className='min-h-screen animate-opacity flex flex-col md:justify-center' id="about">
      ...
      <div className='space-y-4'>
        ...
        <p>I am currently finishing my master's degree in <span className='font-bold'>informatics</span> at Faculty of Electrical Engineering and Informatics of the Technical University of Košice.
        ...
        <p>I started to learn about web development in 2021 on a website called freeCodeCamp, 
          ...
          I also started to explore back-end built with <span className='font-bold'>Node.js </span> and <span className='font-bold'> Express.js</span>.
          Since then I have built several personal projects, which most significant one was my bachelor's/master's thesis, where I have developed a web application for automated testing of student assignments. As of now, I am getting to know Next.js and TypeScript.</p>
      </div>
    </div>
  )
}
