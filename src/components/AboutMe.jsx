  ...
  return (
    <div className='min-h-screen animate-opacity flex flex-col md:justify-center' id="about">
      ...
      <div className='space-y-4'>
        ...
        Even though I am yet to gain professional experience I have worked on multiple <span className='font-bold'> team projects</span> at university. 
        ...
        <p>I started to learn about web development in 2021 on a website called freeCodeCamp, 
          ...
          Since then I have built several personal projects, which you can check below.</p>
      </div>
    </div>
  )
}
